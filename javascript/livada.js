...
function generate_apple(treeDiv, x, y, radius, size) {
    ...
    switch (random_apple) {
        case 0:
            apple.src = '../assets/art/apple1.svg';
            break;
        case 1:
            apple.src = '../assets/art/apple2.svg';
            break;
        case 2:
            apple.src = '../assets/art/apple3.svg';
            break;
        case 3:
            apple.src = '../assets/art/apple4.svg';
            break;
        default:
            break;
    }
...
function generate_tree(min_tree, max_tree) {
    ...
    switch (tree_) {
        case 0:
            treeElement.src = '../assets/art/tree1.svg';
            offset_y = 25;
            break;
        case 1:
            treeElement.src = '../assets/art/tree2.svg';
            break;
        case 2:
            treeElement.src = '../assets/art/tree3.svg';
            offset_y = -10;
            offset_size = -30;
            break;
        default:
...
window.onload = function () {
    ...
    var points = document.getElementById("total").innerHTML,
        min_tree = 150,
        max_tree = 300;
    console.log(points);
